...
namespace spike_model
{
    ...
    public:
        ...
        public:
            ...
            PARAMETER(uint16_t, latency_per_hop, 5, "The latency for each hop")
            ...
            PARAMETER(uint16_t, packet_count_periodicity, 1000, "SRC and DST packet count statistics write periodicity")
        };
    ...
    private:
        ...
        uint16_t                            pkt_count_period_;  //! The number of cycles to write packet count statistics
