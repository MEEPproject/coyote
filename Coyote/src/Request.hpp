...
namespace coyote
{
    class Request : public RegisterEvent, public ParentInstId
    {
        ...
        public:
             ...
             */
            Request(uint64_t a, uint64_t pc, uint16_t c): RegisterEvent(pc, 0, c, -1, coyote::RegisterEvent::RegType::DONT_CARE), ParentInstId(), address(a){}
             ...
             * \param c the requesting core
             */
            Request(uint64_t a, uint64_t pc, uint64_t time, uint16_t c): RegisterEvent(pc, time, c, -1, coyote::RegisterEvent::RegType::DONT_CARE), ParentInstId(), address(a) {}
             ...
             */
            Request(uint16_t coreId, uint64_t regId, coyote::RegisterEvent::RegType regType):
                             RegisterEvent(0, 0, coreId, regId, regType), ParentInstId() {}

            Request(uint16_t coreId): RegisterEvent(0, 0, coreId, -1, coyote::RegisterEvent::RegType::DONT_CARE), ParentInstId() {}

            Request(uint16_t coreId, uint64_t regId): RegisterEvent(0, 0, coreId, -1, coyote::RegisterEvent::RegType::DONT_CARE), ParentInstId() {}
