...
namespace coyote
{
    ...
    pending_acks()
    {
        ...
        address_mapping_policy_=coyote::AddressMappingPolicy::OPEN_PAGE;
        ...
        {
            address_mapping_policy_=coyote::AddressMappingPolicy::CLOSE_PAGE;
        }
        else if(p->address_policy=="row_bank_column_bank_group_interleave")
        {
            address_mapping_policy_=coyote::AddressMappingPolicy::ROW_BANK_COLUMN_BANK_GROUP_INTERLEAVE;
        }
        else if(p->address_policy=="row_column_bank")
        {
            address_mapping_policy_=coyote::AddressMappingPolicy::ROW_COLUMN_BANK;
        }
        else if(p->address_policy=="bank_row_column")
        {
            address_mapping_policy_=coyote::AddressMappingPolicy::BANK_ROW_COLUMN;
        }
        else
        {
    ...
    void MemoryController::receiveMessage_(const std::shared_ptr<coyote::CacheRequest> &mes)
    {
        mes->handle(this);
    }

    void MemoryController::handle(std::shared_ptr<coyote::CacheRequest> r)
    {
    ...
    coyote::AddressMappingPolicy MemoryController::getAddressMapping()
    {
